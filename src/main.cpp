...
const char* UPDATE_TOPIC = "$aws/things/built_in_led/shadow/update";              // publish
const char* UPDATE_DELTA_TOPIC = "$aws/things/built_in_led/shadow/update/delta";  // subscribe
